...
@section('title')
    Halaman Peta Infrastruktur Desa
@endsection
    ...
    <div class="py-14 pt-2">
        @auth
            <div class="flex justify-end mb-3">
                <a href="{{ route('infrastructures.importView') }}"
    ...
    <script>
        ...
        $(function() {
            ...
            $("#search-box").autocomplete({
                source: function(request, response) {
                    var results = $.ui.autocomplete.filter(infrastructureData, request.term);
        ...
        $("#search-box").change(function() {
            setTimeout(() => {
                ...
                if ($("#search-box").val() !== "") {
                    let findLocation = infrastructures.filter(infrastructure => infrastructure.name == $(
                        "#search-box").val())[0]
