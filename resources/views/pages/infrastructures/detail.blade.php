    ...
    <div class="table-wrapper mt-[20px] input-teacher">
        <form class="grid grid-cols-12 gap-4">
            <div class="col-span-12 md:col-span-6 flex flex-col">
                <label for="name" class="form-label">Nama Infrastruktur</label>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-head" id="deleteVillageModalTitle">Hapus Data Lokasi Infrastruktur</h5>
                ...
                <div class="modal-body">
                    <p>
                        Konfirmasi Penghapusan Data Lokasi Infrastruktur: Apakah Anda yakin ingin menghapus
                        data lokasi infrastruktur ini? Tindakan ini tidak dapat dibatalkan dan
                        data lokasi infrastruktur akan dihapus secara permanen dari sistem.
                    </p>
                </div>
                <form action="{{ route('infrastructures.destroy', $infrastructure->id) }}" method="POST"
                    class="d-flex justify-content-center">
                    @csrf
                    @method('DELETE')
                    <div class="flex justify-content-center gap-3 mb-4 w-100 px-4">
                        <button type="submit" class="button btn-main w-100">Hapus</button>
