    ...
    <script>
        ...
        facilities.forEach(facility => {
            if(facility.path) {
                ...
                .bindPopup(`
                    <h6>${facility.name}</h6>
                    <img class="w-full mb-2" src="uploads/facilities/${facility.path}" />
                    <div class="flex justify-center">
                        <a href="facilities/${facility.id}" class="button btn-main text-white px-10 py-0.5" style="font-size: 10px;">Detail</a>    
                    </div>
                `)
            } else {
                L.marker([facility.latitude, facility.longitude]).addTo(map)
